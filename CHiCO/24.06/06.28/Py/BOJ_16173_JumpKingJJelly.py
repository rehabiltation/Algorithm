...
while stack:
    ...
    if x + jumping < N and not visited[x + jumping][y]:
        stack.append((x + jumping, y))
        visited[x + jumping][y] = True


    if y + jumping < N and not visited[x][y + jumping]:
        stack.append((x, y + jumping))
        visited[x][y + jumping] = True
